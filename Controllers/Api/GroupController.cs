...
/* Д.З. Додати до власного курсового проєкту
 * сутності роботи із замовленнями (кошик, оголошення, бронювання)
 *  -- взаємодія користувача із контентом
 * Підготувати необхідні контролери та аксесори 
 */
